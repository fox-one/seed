...
[![GitHub Release](https://img.shields.io/github/v/release/fox-one/seed)](https://github.com/fox-one/seed/releases)
[![Go Reference](https://pkg.go.dev/badge/github.com/fox-one/seed.svg)](https://pkg.go.dev/github.com/fox-one/seed)
[![go.mod](https://img.shields.io/github/go-mod/go-version/fox-one/seed)](go.mod)
[![LICENSE](https://img.shields.io/github/license/fox-one/seed)](LICENSE)
[![Build Status](https://img.shields.io/github/workflow/status/fox-one/seed/build)](https://github.com/fox-one/seed/actions?query=workflow%3Abuild+branch%3Amain)
[![Go Report Card](https://goreportcard.com/badge/github.com/fox-one/seed)](https://goreportcard.com/report/github.com/fox-one/seed)
[![Codecov](https://codecov.io/gh/fox-one/seed/branch/main/graph/badge.svg)](https://codecov.io/gh/fox-one/seed)
...
1. Replace all occurences of `fox-one/seed` to `your_org/repo_name` in all files.
